...
- **Kill stats** notice each kill -- 3K's death line, then its killing blow -- and keep who killed it, how many rounds and how long it took, the damage you dealt and took (3K's numbers, before your defenses), and the xp and coins it gave, which it asks 3K for with `xp` and `coins` and keeps off the screen. `.kills` shows the last fifteen with totals, a kill's average and the rates an hour; `.kills 40` shows more, `.kills <mob>` only those, `.kills clear` starts again, and `.kills ask off` stops the questions. 3kdb's `3kReport` and `3kReport-clear` work too. The kill count and xp an hour sit in the Session panel.
